...
estado --- número convergente, em safra e agregação distintas, com os 27,4\%
estimados por \citet{haddad2017iioas}. A dispersão setorial é grande
(Tabela~\ref{tab:vaz}): serviços imobiliários quase não vazam (5,3\%),
enquanto alimentos vazam 37,4\%. No emprego, nos setores pesados metade ou
mais do trabalho puxado pela demanda capixaba realiza-se fora do ES
(Tabela~\ref{tab:emp}).
