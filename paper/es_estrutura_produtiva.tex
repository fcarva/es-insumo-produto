...
emprego. É a composição, não a decomposição, que o singulariza.
...
2\textordmasculine\ mais intensivo em setores de base do país e um dos dois (com o RJ) cujo setor
dominante é a Mineração. Fonte: \texttt{outputs/cluster\_setorial.csv}.}
\label{tab:cluster}
\end{table}
...
assinatura de enclave, agora na dimensão territorial do fluxo.
...
a concentração territorial já indicava (\S\ref{sec:territorio}), agora pelo lado do fluxo. A pequenez do \emph{feedback} é, em parte,
...
\citet{araujojunior2018cgv}. É a tradução, na escala da cadeia global, do mesmo diagnóstico:
