...
outra safra e outra agregação. A segunda é a regionalização da matriz por quocientes locacionais
corrigidos ou por ajuste biproporcional: métodos como FLQ/AFLQ \citep{flegg1995lq,flegg2000flq}
e GRAS \citep{junius2003gras} são centrais para painéis multi-safra --- sobretudo com matrizes de
entradas negativas ou regiões pequenas ---, mas aqui entram apenas como critério de leitura dos
limites; os resultados reportados são os que se rastreiam diretamente às três matrizes disponíveis.
...
vetor de emprego (apenas remunerações).
