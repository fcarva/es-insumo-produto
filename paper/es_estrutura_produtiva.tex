...
emerges as key sectors. A final-demand decomposition quantifies the decoupling: demand
...
\citep{porsse2008matriz}, Pará \citep{sessofilho2010para} e Santa Catarina
\citep{bittencourt2023sc}; o recorte multiestadual tem precedente no sistema
...
Espírito Santo, com dois instrumentos de aferição que o gênero raramente emprega: o
benchmark interestadual e o modelo nulo de porte, que separam, no retrato, o que é
regularidade do método do que é específico do estado.
...
para trás. Fonte: \texttt{19\_fig\_caracterizacao.py} sobre
...
os exatos. Fonte: \texttt{21\_fig\_micro.py} sobre \texttt{outputs/micro\_LQ.csv}.}
\label{fig:vocacao}
\end{figure}
...
é de agregação (Apêndice~\ref{ap:medias}). Fonte: \texttt{11\_fig\_sankey.py} sobre
...
\texttt{09\_fig\_upstreamness.py} sobre \texttt{outputs/es\_upstreamness.csv}.}
\label{fig:upstream}
\end{figure}
...
(2011) e outra agregação (68 setores).
