...
\emph{residentes}, voltadas ao mercado interno, que carregam a ocupação.
...
a periferia extrativa vaza. Fonte: \texttt{24\_micro\_mult\_chave.py} sobre
...
de~\eqref{eq:feedback} é $(\Delta_{LL}-I)\Delta_L\,y^{L}$.
...
Metropolitana do sistema microrregional (\S\ref{sec:territorio}).
